...
"""
Change this file so that James 
can enter a specific PIm number for a patient
set a flag to give James the option to run automatic or manual segmentation.
