...
# Base imports
import argparse # For parsing flag values from command line
import sys # ??? 
import numpy as np # ??? 
...
from utils import constants # Different enums for setting default class attributes (e.g. reference_key, bias_key, etc...) 
...
class Config(config_dict.ConfigDict):
    ...
    def __init__(self):
        ...
        self.hb = 0.0
        self.subject_id = "PIm0377" # CHANGE
        self.rbc_m_ratio = 0.575 # Somehow hook this up to calculate_rbc_m_ratio
